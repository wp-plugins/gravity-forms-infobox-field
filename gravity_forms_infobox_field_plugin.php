		...
		<script type='text/javascript'>
			jQuery(document).ready(function($) {
				...
				jQuery(document).bind("gform_load_field_settings", function(event, field, form){					
					jQuery("#field_Infobox_type").val(field["field_Infobox_type"] == undefined ? "help" : field["field_Infobox_type"]);
					jQuery("#field_Infobox_more_info").val(field["field_Infobox_more_info"] == undefined ? "" : field["field_Infobox_more_info"]);
...
?>
			<link rel="stylesheet" type="text/css" href="<?php echo plugins_url('itsp_infobox_css.css', __FILE__);?>" media="all" />
				...
				$('.'+ e.target.classList[1]+'_box').toggle(); 
					});
				});
			</script>
		 <?php
